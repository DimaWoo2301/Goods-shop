...
const ShowCaseWindow = () => {
  ...
  const [img, setImg] = useState(bodyIndex.mainImage)

  const colorReplacement = () => {
    setImg("https://avatars.mds.yandex.net/get-mpic/5240013/img_id8615115285392917639.jpeg/orig")
  }
      ...
      <div className={s.color}>
        <div className={s.infoPhone}>
          ...
          <div className={s.radius}>
            <div onClick={colorReplacement} className={s.circle + " " + s.circleR}/>
            <div className={s.circle + " " + s.circleB}/>
            <div className={s.circle + " " + s.circleY}/>
          </div>
